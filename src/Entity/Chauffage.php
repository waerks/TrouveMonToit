...
class Chauffage
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Energie::class, mappedBy: 'chauffages', orphanRemoval: true)]
    ...
    public function removeEnergy(Energie $energy): static
    {
        if ($this->energies->removeElement($energy)) {
            ...
            if ($energy->getChauffages() === $this) {
                $energy->setChauffages(null);
            }
        }
